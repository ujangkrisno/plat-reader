...
<nav class="navbar navbar-dark px-3 mb-4">
    ...
    <div>
        ...
        <a href="upload_test.php" class="btn btn-outline-light btn-sm me-2"><i class="fas fa-upload"></i> Upload Foto</a>
        <a href="detect_live.php" class="btn btn-outline-light btn-sm"><i class="fas fa-bolt"></i> Live Detect</a>
